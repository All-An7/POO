 ...
 * @author Fatec
 */
@WebServlet(name = "AllanMathServlet", urlPatterns = {"/operacao.html"})
public class AllanMathServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Servlet AllanMathServlet at " + request.getContextPath() + "</h1>");
            int n1 = 2;
            int n2 = 2;
            String op = "";
            try{
                ...
                op = request.getParameter("op");
                            ...
                            +"ERROOOOUU Parâmetro inválido</div>");
                            }
